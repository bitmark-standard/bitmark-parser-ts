...
es6: $(grammar_file)
	python ./tools/replace_parser_content.py ./Interview/_interviewLexer.g4 ./MiscBits/common_lexer.g4 ./Interview/interviewLexer.g4 '<<<<<<common<<<<<<'
	python ./tools/replace_parser_content.py ./Interview/_interviewParser.g4 ./MiscBits/common_parser.g4 ./Interview/interviewParser.g4 '<<<<<<common<<<<<<'

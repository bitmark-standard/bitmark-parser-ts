...
lexer_file=$(antlr_dir)/chatLexer.g4
parser_file=$(antlr_dir)/chatParser.g4
js_files = chatLexer.js chatParser.js chatListener.js

.DEFAULT_GOAL = es6

es6: $(grammar_file)
	python ./tools/replace_parser_content.py ./Chat/_chatLexer.g4 ./MiscBits/common_lexer.g4 ./Chat/chatLexer.g4 '<<<<<<common<<<<<<'
	python ./tools/replace_parser_content.py ./Chat/_chatParser.g4 ./MiscBits/common_parser.g4 ./Chat/chatParser.g4 '<<<<<<common<<<<<<'
...
clean:
	$(RM) $(js_files) ./Chat/*.ts ./Chat/antlr/*

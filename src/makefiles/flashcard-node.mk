...
es6: $(grammar_file)
	python ./tools/replace_parser_content.py ./Flashcard/_flashcardLexer.g4 ./MiscBits/common_lexer.g4 ./Flashcard/flashcardLexer.g4 '<<<<<<common<<<<<<'
	python ./tools/replace_parser_content.py ./Flashcard/_flashcardParser.g4 ./MiscBits/common_parser.g4 ./Flashcard/flashcardParser.g4 '<<<<<<common<<<<<<'

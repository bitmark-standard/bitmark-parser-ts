...
es6: $(grammar_file)
	python ./tools/replace_parser_content.py ./Cloze/_clozeLexer.g4 ./MiscBits/common_lexer.g4 ./Cloze/clozeLexer.g4 '<<<<<<common<<<<<<'
	python ./tools/replace_parser_content.py ./Cloze/_clozeParser.g4 ./MiscBits/common_parser.g4 ./Cloze/clozeParser.g4 '<<<<<<common<<<<<<'

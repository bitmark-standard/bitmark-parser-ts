...
es6: $(grammar_file)
	python ./tools/replace_parser_content.py ./MiscBits/_bitmarkLexer.g4 $(common_lexer_file) $(bitmark_lexer_file) '<<<<<<common<<<<<<'
	python ./tools/replace_parser_content.py ./MiscBits/_bitmarkParser.g4 $(common_parser_file) $(bitmark_parser_file) '<<<<<<common<<<<<<'

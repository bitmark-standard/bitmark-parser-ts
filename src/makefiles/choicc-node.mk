...
es6: $(grammar_file)
	python ./tools/replace_parser_content.py ./Choice/_choiceLexer.g4 ./MiscBits/common_lexer.g4 ./Choice/choiceLexer.g4 '<<<<<<common<<<<<<'
	python ./tools/replace_parser_content.py ./Choice/_choiceParser.g4 ./MiscBits/common_parser.g4 ./Choice/choiceParser.g4 '<<<<<<common<<<<<<'

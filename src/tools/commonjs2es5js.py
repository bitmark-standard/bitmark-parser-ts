...
fromto_re = [
   ...
   {"from": "const\s(\w+)\s*=\s*require\('antlr4ts/(\w+).js'\)",
    "to": "import { \\2 } from './TypeScript/antlr4es6/\\2.js'"},
   
   {"from": "const\s(\w+)\s*=\s*require\('antlr4ts/tree/\w+.js'\)",
    "to": "import { \\1 } from './TypeScript/antlr4es6/tree/\\1.js'"},
   {"from": "const\s(\w+)\s=\srequire\('antlr4ts/atn/\w+.js'\)",
    "to": "import { \\1 } from './TypeScript/antlr4es6/atn/\\1.js'"},
   {"from": "const\s(\w+)\s=\srequire\('\./typescript/\w+.js'\)",
    "to": "import { \\1 } from './TypeScript/\\1.js'"},

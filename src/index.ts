...
import { bitmarkLexer } from "./antlr/bitmarkLexer.ts";
import { bitmarkParser } from "./antlr/bitmarkParser.ts";
import { clozeLexer } from './antlr/clozeLexer.ts';
import { clozeParser } from './antlr/clozeParser.ts';
import { matchLexer } from './antlr/matchLexer.ts';
import { matchParser } from './antlr/matchParser.ts';
import { choiceLexer } from './antlr/choiceLexer.ts';
import { choiceParser } from './antlr/choiceParser.ts';
import { interviewLexer } from './antlr/interviewLexer.ts';
import { interviewParser } from './antlr/interviewParser.ts';
import { truefalseLexer } from './antlr/truefalseLexer.ts';
import { truefalseParser } from './antlr/truefalseParser.ts';
import { flashcardLexer } from './antlr/flashcardLexer.ts';
import { flashcardParser } from './antlr/flashcardParser.ts';
import { chatLexer } from './antlr/chatLexer.ts';
import { chatParser } from './antlr/chatParser.ts';
import { sequenceLexer } from './antlr/sequenceLexer.ts';
import { sequenceParser } from './antlr/sequenceParser.ts';
